...
export const cases = [
  ...
  { label: "Mall Advertising Network", slug: "mall-advertising", image: starbucksImg, video: "/videos/dooh.mp4", description: "High-impact digital out-of-home displays that monetize footfall in premium locations." },
  { label: "Airport Brand Campaigns", slug: "airport-campaigns", video: "/videos/dooh.mp4", description: "Captive-audience engagement through holographic displays in departure lounges and terminals." },
  { label: "Corporate Lobby Installations", slug: "corporate-lobby", image: brandsImg, description: "Stunning welcome experiences that communicate brand identity through light and motion." },
  ...
  { label: "Airline In-Flight Experience", slug: "airline-experience", video: "/videos/hospitality.mp4", description: "Elevating passenger journey with interactive holographic entertainment and information." },
        ...
        <div className="relative md:hidden">
          ...
          >
            ...
            {cases.map((c, i) => (
              ...
              >
                <div className="relative h-[70vw] max-h-[320px] w-full overflow-hidden">
                  {c.video ? (
          ...
          <div className="mt-4 flex justify-center gap-4">
            <button
              ...
              className="glass-panel flex h-10 w-10 items-center justify-center rounded-full transition-opacity disabled:opacity-20"
            >
            ...
            return (
              ...
              >
                ...
                <div className={`w-1/2 ${isLeft ? "" : "text-right"}`}>
                  <p className="font-display text-[10px] tracking-[0.3em] text-glow-primary">
                  ...
                  <button
                    onClick={() => navigate(`/use-cases/${c.slug}`)}
                    className="mt-6 font-display text-[10px] tracking-[0.25em] text-glow-primary transition-colors hover:text-foreground"
                  >
                    EXPLORE CASE →
                  </button>
                </div>
